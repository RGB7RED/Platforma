...
- **Planner**
  - Цель: детализировать реализацию по архитектуре и требованиям.
  - Ограничения: не пишет код и не меняет требования.
  - Артефакты: `implementation_plan`, `plan_version`, `plan_step_index`.
- **Coder**
...
Если финальное ревью не проходит, цикл возвращается на стадию **planning**,
план обновляется с учётом замечаний, затем **implementation** и **review** повторяются.
